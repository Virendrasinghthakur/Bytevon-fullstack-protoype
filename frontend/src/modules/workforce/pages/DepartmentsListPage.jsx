      ...
      <div className="border-b border-slate-200 bg-white px-6 py-4">
        ...
        {selectedDept && (
          <p className="mt-2 text-sm text-sky-700">
            Selected via picker: <strong>{selectedDept.name}</strong>
          </p>
        )}
      </div>
          ...
          <table className="w-full text-left text-sm">
            <thead className="border-b border-slate-100 bg-slate-50 text-xs uppercase text-slate-500">
              <tr>
                ...
                <th className="px-4 py-3 hidden sm:table-cell">Head</th>
                <th className="px-4 py-3">Staff</th>
                <th className="px-4 py-3 hidden md:table-cell">Projects</th>
              ...
              {departments.map((d) => (
                <tr key={d.id} className="hover:bg-slate-50">
                  <td className="px-4 py-3">
                    <Link to="/workforce/departments/$departmentId" params={{ departmentId: d.id }} className="flex items-center gap-3">
                      <div
                      ...
                      <div>
                        <div className="font-medium text-slate-900 hover:text-sky-600">{d.name}</div>
                  ...
                  <td className="px-4 py-3">
                    <Link to="/workforce/departments/$departmentId" params={{ departmentId: d.id }} className="text-slate-400 hover:text-sky-600">
